...
//   }
// }, {
//   timestamps: false // We'll handle manually
// });

// // Compound unique index: One attendance per user per day
// attendanceSchema.index({ userId: 1, date: { $gte: new Date(new Date().setHours(0,0,0,0)) } }, { 
//   unique: true,
//   partialFilterExpression: { date: { $gte: new Date(new Date().setHours(0,0,0,0)) } }
// });

// // Index for active shifts
// attendanceSchema.index({ userId: 1, status: 1 });

// // Pre-save middleware to update updatedAt and calculate totalHours
// attendanceSchema.pre('save', function(next) {
//   this.updatedAt = new Date();
  
//   // Calculate total hours if both startTime and endTime exist
//   if (this.startTime && this.endTime && this.status === 'completed') {
//     const diffMs = this.endTime - this.startTime;
//     this.totalHours = parseFloat((diffMs / (1000 * 60 * 60)).toFixed(2)); // Hours with 2 decimals
//   }
...
// // Static method to get today's date start (00:00:00)
// attendanceSchema.statics.getTodayStart = function() {
//   const today = new Date();
//   today.setHours(0, 0, 0, 0);
//   return today;
// };

// // Static method to get today's date end (23:59:59)
// attendanceSchema.statics.getTodayEnd = function() {
//   const today = new Date();
...
//   const todayStart = Attendance.getTodayStart();
//   const todayEnd = Attendance.getTodayEnd();
...
// // Index for user and date (for fast lookups)
